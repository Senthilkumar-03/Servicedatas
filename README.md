In this application the main task is to read the service data's from the WINDOWS MANAGEMENT INSTRUMENTATION and to display the content in web in tableformat. In the table
